...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2022 at 08:46 AM
...
INSERT INTO `nilai_diniah` (`id_nilai_diniah`, `id_santri`, `id_kelas`, `id_guru`, `id_detail_mapel`, `nilai`, `tgl_inp_nilai`, `semester`, `id_kelas_diniah`) VALUES
(1, 31, 1, 1, 1, 90, '2022', 'Genab', 2),
(2, 28, 1, 1, 1, 34, '2022', 'Genab', 1),
(4, 27, 1, 1, 1, 78, '2022', 'Genab', 1),
(5, 36, 1, 1, 1, 80, '2022', 'Genab', 1),
(6, 32, 2, 3, 6, 90, '2022', 'Genab', 2),
(7, 35, 2, 3, 6, 70, '2022', 'Genab', 2),
(8, 27, 1, 5, 3, 70, '2022', 'Genab', 1),
(9, 28, 1, 5, 3, 40, '2022', 'Genab', 1),
(10, 31, 1, 5, 3, 99, '2022', 'Genab', 1),
(11, 50, 1, 5, 3, 78, '2022', 'Genab', 1),
(12, 36, 1, 5, 3, 100, '2022', 'Genab', 1),
(13, 32, 2, 7, 8, 80, '2022', 'Genab', 2),
(14, 35, 2, 7, 8, 70, '2022', 'Genab', 2);
...
INSERT INTO `santri` (`id_santri`, `id`, `Nama`, `Kelas_ummi`, `Kelas_diniah`, `Umur`, `Jenis_kelamin`, `Nama_ayah`, `Nama_ibu`, `Tahun_pendaftaran`, `Sekolah_formal`, `No_HP_ortu`, `Alamat`, `Verification`) VALUES
(27, 1, 'hadi', '6', '2', '2022', 'L', 'suteno', 'karmiem', NULL, NULL, NULL, NULL, 'Y'),
(28, 3, 'rico', '6', '1', '1998', 'L', 'goku', 'noni', NULL, NULL, NULL, NULL, 'Y'),
(31, 4, 'teguh saipul', '6', '1', '1999', 'L', 'asep', 'megan susanti', NULL, NULL, NULL, NULL, 'Y'),
(32, 5, 'susi jaenab', '6', '2', '2007', 'P', 'john mclaner', 'aisyah', NULL, NULL, NULL, NULL, 'Y'),
(35, 6, 'nopal aryanto', '6', '2', '2009-05-21', 'L', 'burhan atmaja', 'rina maria', NULL, '6 SD', '085371899', 'jl.sigura-gura no.10 kota malang', 'Y'),
(36, 7, 'sinta kusumawati', '7', '2', '2012-12-12', 'P', 'beni nurcahyo', 'mayang cantika', '2022', '4 SD', '081887791', 'jl. jatisari kel. ngaglik kota batu', 'Y'),
(37, 8, 'farhan abas', NULL, NULL, '2011-03-19', 'L', 'ari akbar', 'maulina wijaya', '2022', '5 SD', '0814582200', 'jl. sigura-gura no.55, malang', 'Y'),
(49, 9, 'joko dafid', NULL, NULL, '2014-06-13', 'L', 'murshid', 'jessika ainur', '2022', '2 sd', '08178593301', 'jl.sigura-gura no.07', 'Y'),
(50, 10, 'nanda afrian', NULL, NULL, '2013-07-25', 'L', 'heru akbar', 'nur laly', '2022', '5 SD', '0816277829', 'jl.sigura-gura no.7', 'Y');
...
(29, '::1', NULL, '$2y$10$iJRwJCsgjiFfkew2aFdORe1gIAuHgLJktiqhzbZvbj/Rfp9qgXLvO', 'guru1@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1653539120, 1666506884, 1, 'guru1', 'guru', 'guru', 'admin'),
(30, '::1', NULL, '$2y$10$3R3qkRb0Z6UdcHD0dd25S.2V76s6Y7NlhdMNUuRxfZXwplyYS8I72', 'admin_assifa@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1653539353, 1666498837, 1, 'fabi', 'al katiri', 'assifa', '08999'),
(31, '192.168.1.13', NULL, '$2y$10$xUDSUuMogpmqpwd/9w6Q1umsR86/8dbcnyb3iNDLYijR6dbv8wkMi', 'saipul69@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1654671771, 1665980860, 1, NULL, NULL, NULL, NULL),
...
(34, '192.168.1.13', NULL, '$2y$10$qVosjIx7C3wFWJF7rQ8zoeKZ8gduhViFCWHVSZV2z/Xk9qBH6tD2y', 'guru2@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1654673242, 1666463580, 1, NULL, NULL, NULL, NULL),
...
(39, '192.168.1.17', NULL, '$2y$10$0jj7ebyE0/JHXPvf3BEibO7a6kPURYufHk4ffxkLlBDyQ167wTlOi', 'guru3@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1656523526, 1666501180, 1, NULL, NULL, NULL, NULL),
...
(41, '192.168.1.17', NULL, '$2y$10$17gZWLpDY60Sz2P/TSbfnOv4H7VBmFn6qA6ySTngsQ2CaBlnO9Q4q', 'nurcahya@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1656666707, 1666501208, 1, NULL, NULL, NULL, NULL),
...
(47, '192.168.1.17', NULL, '$2y$10$MIE1UrrrKyDty3YCAToCku7YBIvnTTracdWMrutUYs7xXTWWnRIJS', 'bayuaji@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1656667142, 1666501241, 1, NULL, NULL, NULL, NULL),
...
--
ALTER TABLE `nilai_diniah`
  MODIFY `id_nilai_diniah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `nilai_ummi`
--
ALTER TABLE `nilai_ummi`
  MODIFY `id_nilai_ummi` int(11) NOT NULL AUTO_INCREMENT;
