...
insert  into `kelas_guru`(`id_kelas_guru`,`id_kelas`,`id_guru`,`kls_guru_status`,`id_mapel`) values (2,3,2,NULL,1),(3,4,2,NULL,1),(4,6,1,NULL,5),(5,1,3,NULL,2),(6,2,1,NULL,1),(8,2,3,NULL,2),(9,1,1,NULL,1),(10,4,4,NULL,2),(11,3,4,NULL,2),(12,2,5,NULL,3),(13,1,5,NULL,3),(14,1,7,NULL,4),(15,3,8,NULL,4),(16,7,2,NULL,6),(17,8,3,NULL,7),(18,9,4,NULL,8),(19,10,5,NULL,9),(20,11,6,NULL,10),(21,12,7,NULL,11),(22,13,8,NULL,12),(24,2,7,NULL,NULL),(25,2,7,NULL,4),(26,3,6,NULL,3),(27,4,6,NULL,3),(28,4,8,NULL,4);
...
insert  into `kelas_santri_ummi`(`id_kelas_ummi`,`id_santri`,`id_kelas`) values (1,27,1),(2,27,4),(3,28,10),(4,36,13);
...
/*Table structure for table `raport_ummi` */

DROP TABLE IF EXISTS `raport_ummi`;

CREATE TABLE `raport_ummi` (
  `id_raport_ummi` int(11) NOT NULL AUTO_INCREMENT,
  `id_santri` int(11) DEFAULT NULL,
  `id_kelas` int(11) DEFAULT NULL,
  `id_guru` int(11) DEFAULT NULL,
  `id_detail_mapel` int(11) DEFAULT NULL,
  `nilai` int(11) DEFAULT NULL,
  `tanggal_raport` date DEFAULT NULL,
  PRIMARY KEY (`id_raport_ummi`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `raport_ummi` */
