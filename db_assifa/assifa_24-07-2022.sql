...
insert  into `kelas_guru`(`id_kelas_guru`,`id_kelas`,`id_guru`,`kls_guru_status`,`id_mapel`,`walikelas`) values (2,3,2,NULL,1,NULL),(3,4,2,NULL,1,NULL),(4,6,1,NULL,5,'Walikelas'),(5,1,3,NULL,2,NULL),(6,2,1,NULL,1,NULL),(8,2,3,NULL,2,NULL),(9,1,1,NULL,1,NULL),(10,4,4,NULL,2,NULL),(11,3,4,NULL,2,NULL),(12,2,5,NULL,3,NULL),(13,1,5,NULL,3,NULL),(14,1,7,NULL,4,NULL),(15,3,8,NULL,4,NULL),(16,7,2,NULL,6,'Walikelas'),(17,8,3,NULL,7,'Walikelas'),(18,9,4,NULL,8,'Walikelas'),(19,10,5,NULL,9,'Walikelas'),(20,11,6,NULL,10,'Walikelas'),(21,12,7,NULL,11,'Walikelas'),(22,13,8,NULL,12,'Walikelas'),(24,2,7,NULL,4,NULL),(26,3,6,NULL,3,NULL),(27,4,6,NULL,3,NULL),(28,4,8,NULL,4,NULL);
...
insert  into `kelas_santri_diniah`(`id_kelas_diniah`,`id_santri`,`id_kelas`) values (1,27,1),(2,28,1),(3,31,1),(4,32,2),(5,35,2);
...
insert  into `kelas_santri_ummi`(`id_kelas_ummi`,`id_santri`,`id_kelas`) values (1,27,6),(2,37,6),(3,28,6),(4,36,6),(5,31,6),(6,32,6);
...
insert  into `nilai_diniah`(`id_nilai_diniah`,`id_santri`,`id_kelas`,`id_guru`,`id_detail_mapel`,`nilai`,`tgl_inp_nilai`,`semester`,`id_kelas_diniah`) values (1,31,1,1,1,89,'2022','Genab',4),(2,27,1,1,1,56,'2022','Genab',4),(3,28,1,1,1,75,'2022','Genab',1);
