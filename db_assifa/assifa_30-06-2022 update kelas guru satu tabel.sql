...
insert  into `guru`(`id_guru`,`user_id`,`Nama`,`Jenis_kelamin`,`no_hp`,`tanggal_lahir`,`Verification`,`Kelas_ummi`,`Kelas_diniah`,`Status_guru`) values (1,29,'amir khan','L','085757575','1995-06-08','Y','2','1','aktif'),(2,34,'guru2','L','08890966','1997-09-12','Y','1','2',NULL),(3,39,'guru3','P','0894422911','1997-07-15','Y',NULL,NULL,'aktif');
...
insert  into `kelas`(`id_kelas`,`Kelas`,`kd_kelas`) values (1,'Sughro','diniah'),(2,'Wustho A','diniah'),(3,'Wustho B','diniah'),(4,'Kubro','diniah'),(5,'Lulus','diniah'),(6,'Pra Ummi','ummi'),(7,'Ummi1','ummi'),(8,'Ummi2','ummi'),(9,'Ummi3','ummi'),(10,'Ummi4','ummi'),(11,'Ummi5','ummi'),(12,'Ummi6','ummi'),(13,'Lulus','ummi');
...
insert  into `kelas_guru`(`id_kelas_guru`,`id_kelas`,`id_guru`,`kls_guru_status`) values (2,1,2,'deleted'),(3,2,2,NULL),(4,7,1,NULL),(5,4,3,NULL);
...
insert  into `users_groups`(`id`,`user_id`,`group_id`) values (1,1,1),(2,1,2),(3,2,3),(4,3,4),(16,14,3),(30,26,4),(28,27,3),(29,28,6),(32,29,6),(34,30,4),(35,31,3),(36,32,3),(37,33,3),(38,34,6),(39,35,3),(40,36,3),(41,37,3),(42,38,3),(43,39,6);
