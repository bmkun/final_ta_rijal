<div class="main-panel">
    <div class="content-wrapper">
        ...
        <?php if ($status_biodata == "nothing") { ?>
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" method="POST" action="<?= site_url("guru_access/submit_biodata") ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail3" name="no_hp">
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" method="POST" action="<?= site_url("Guru_access/submit_biodata") ?>">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail3">Tanggal Lahir</label>
                            <input type="text" class="form-control" id="exampleInputEmail3" name="tgl_lahir" value="<?= $show_biodata['tanggal_lahir']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleSelectGender">Jenis Kelamin</label>
                            <input type="text" class="form-control" id="exampleInputEmail3" name="tgl_lahir" value="<?php $gender = $show_biodata['Jenis_kelamin'] == "P" ? "Perempuan " : "Laki - laki";
                                                                                                                    echo $gender; ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail3">No HP</label>
                            <input type="text" class="form-control" id="exampleInputEmail3" name="no_hp" value="<?= $show_biodata['no_hp']; ?>">
                        </div>
