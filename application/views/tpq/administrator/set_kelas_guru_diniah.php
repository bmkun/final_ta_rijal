        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Kelas Guru Diniah</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?= site_url("administrators/action_kelas_guru_diniah/") . $kd_direct ?>">
        ...
        <div class="modal fade" id="edit<?= $guru['id_kelas_guru'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?= site_url("administrators/update_kelas_guru_diniah/") ?>">
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Nama Guru</label>
                                <!-- <input type="text" class="form-control" id="recipient-name"> -->
