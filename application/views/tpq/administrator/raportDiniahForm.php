            ...
            <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            <form class="mt-4" target="_blank" action="<?= site_url('administrators/printRaportDiniah') ?>" method="post" accept-charset="utf-8">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            <form class="mt-4" target="_blank" action="<?= site_url('administrators/raport_diniah') ?>" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="" class="form-control" id="eml">
                                                <?php foreach ($tahun as $showTahun) { ?>
                                                    <option value="<?= $showTahun['tgl_inp_nilai'] ?>"><?= $showTahun['tgl_inp_nilai'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
