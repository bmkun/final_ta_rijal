    ...
    ?>
        <div class="container">
            ...
            <table>
                <tr>
                    <td>
                        <h6>NAMA : <?= ucwords($raportDiniah['dataSantri'][$i]['Nama']) ?></h6>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h6>KELAS : <?= ucwords($raportDiniah['dataSantri'][$i]['Kelas']) ?></h6>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h6>TAHUN AJARAN : <?= $raportDiniah['dataSantri'][$i]['Tahun_pendaftaran'] ?> </h6>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <table class="table table-bordered" id="border">
                ...
                <tbody>
                    <?php
                    for ($mapel = 0; $mapel <= 3; $mapel++) {
                    ?>
                        <tr>
                            <td align="center"><?=$mapel+1?></td>
                            <td width="300"><?= $raportDiniah['nilaiSantri'][$i][$mapel]['detail_mapel'] ?></td>
                            <td align="center"><?= $raportDiniah['nilaiSantri'][$i][$mapel]['nilai'] ?></td>
                            <td>
                            <?= $raportDiniah['nilaiSantri'][$i][$mapel]['catatan'] ?> 
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <div class="row text-center">
                ...
                <div class="col-4">
                    ...
                    <br>
                    <br>
                    <h5><?= $raportDiniah['waliKelas'][$i]['namaGuru'] ?></h5>
                </div>
                <div class="col-4">
